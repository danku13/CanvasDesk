...
---
Task ID: FR-067 (этап F, сессия web-d435bede)
...
- К1 be82bb9: FR-067 постановка (docs/change-requests/fr-067-node-body-fill-stage-f.md) + строка индекса; решения открытых вопросов: I-6 не отменяется (ужимание — вне этапа F), ⓘ не переносится (нет в прототипе), guide_gap — узловой токен.
...
- К8: статус FR-067 → выполнено, ACCEPTANCE.md (FR-067.1–12), index-cr-fr.md, этот worklog.
