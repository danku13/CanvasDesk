...
494 (feat(node-body): FR-061 хвосты, коммит 1 — свёрнутость блока Н-2 (runtime), клик по заголовку (строка+chevron), экспандер описания «⋯ целиком ▾», Q3 desc→манифест→проза)
