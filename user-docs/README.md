...
| `calculations.md` | Numi-формулы, единицы, value-связи, `$in`, what-if сценарии |
...
| `admin.md` | UI-консоль: админпанель дизайн-системы — матрица состояний, наполнение, сущности канваса, токены (FR-070) |
...
После включения Pages по варианту выше используйте эти адреса (они же —
