...
impl SceneState {
    ...
    fn recompute_flow(&mut self) {
        ...
        for node in &self.canvas.nodes {
            ...
            // FR-029: и именованных выходов (fromOutput)
...
mod tests {
    ...
    fn graph_apply_assembles_mini_reference_with_oracle() {
        ...
        let ops = r#"[
            ...
            {"op":"edge_create","fromRef":"cdn","toRef":"gw","kind":"value","fromOutput":"origin","toParam":"rps"},
        ...
        assert_close(
            flow[cdn_node_id]["outputs"]["origin"]["value"]
                .as_f64()
                .expect("origin"),
            20.8333,
            "именованный выход CDN.origin (проливание rps = 208.33)",
        );
        ...
        assert_close(
            flow[cdn_node_id]["outputs"]["origin"]["value"]
                ...
                .expect("origin ×2"),
            41.6667,
            "CDN.origin после удвоения DAU — проливание живое",
        );
    }
