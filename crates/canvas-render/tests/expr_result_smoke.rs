...
fn expr_line_results_draw_on_own_rows() {
    ...
    // origin тела = (x+10, y+28+4) → screen (20, 42). Ряд 0: y = 42..62;
    // ряд 1: блок 0 (20) + зазор 6 → y = 68..88.
