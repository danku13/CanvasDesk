...
## 8. Отступления при реализации (заполнит координатор T14-C)

- (зарезервировано; заранее известно: PDF-текст отложен вместе с T11 до
  момента после v1 — по решению владельца; зафиксировать здесь)
