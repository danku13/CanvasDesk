...
- **Статус:** в работе (W0 выполнено 2026-09-25 — гейты зелёные; W1 выполнено 2026-09-25 — гейты зелёные, taffy opt-in за фичей, wasm +283.9 КБ raw post-opt; **W2 выполнено 2026-09-25** — гейты зелёные: FlexLayoutEngine побитово-паритетен taffy (1000/1000 деревьев, 15/15 demos на общем golden), Shaper trait изолировал cosmic-text, wasm дельта +692 байта raw; ADR-0015 принят владельцем; W3–W4 — по плану; замечание владельцу: абсолютный wasm-лимит raw 8 МБ превышен ДО W1 на default-бандле (8.72→8.83 МБ с web-sys 0.3.104 + unstable-API — вне рамок W2) — решение по §Контракту-7 за владельцем)
