...
- **Статус:** этапы A+B+C выполнены (2026-09-23); этап D (полировка: токены/motion/i18n, DebugOverlay направляющих, кламп описания D-8, ellipsis формулы, свёрнутость блока) и этап E (kit-Row) — постановка
- **Тип:** FR
- **Приоритет:** высоко
