...
- **Статус:** этапы A+B+C выполнены (2026-09-23); **этап D в работе** (2026-09-23, приказ владельца «Продолжай реализацию D этапа»: D-14 токены/motion/i18n, DebugOverlay направляющих Q9, алиасы O-5 rich-формулы, D-8 описание+кламп; отложено — свёрнутость блока/клик и экспандер описания (hit-зоны app.rs — по отдельному согласованию, как зафиксировано в истории B+C), ellipsis формулы, VLM-ревью — визуальная приёмка); этап E (kit-Row) — постановка
- **Тип:** FR
- **Приоритет:** высоко
