...
- **Статус:** в работе (X0–X3 выполнены 2026-09-22 — FR-048, ядро `lineage.rs`, окно проверки/триггер/подсветка/лоадер/кэш; what-if из дерева — подмена листа/дельты/сценарии; демо-гейт Q6; далее X4 — автосвязь)
