...
| Режим защиты | под-состояние панели (§6.4): панель остаётся видимой, дерево укрупняется (У9 — под вопросом, решение по HTML-прототипу `docs/prototypes/ux-defense-mode.html`); другие оверлеи недоступны |
...
| X5 | Режим защиты F-8 (поведение панели — по решению У9 после просмотра прототипа) | US-6 |
...
- `docs/prototypes/ux-review-dialog.html` (У7/У8), `docs/prototypes/ux-defense-mode.html` (У9) — интерактивные HTML-прототипы UX-решений Q8; решения владельца — после просмотра.
