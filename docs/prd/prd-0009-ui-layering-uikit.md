...
- **Статус:** в работе (U0–U3 и U5 выполнены — FR-051/FR-052/FR-053/FR-054; U4 UI kit/DebugOverlay — не заказан владельцем, остаётся за пределами PoC-этапов U5)
...
- [ ] G6: F9-оверлей показывает слои/rect'ы/имя под курсором; пересечения подсвечены; работает в wasm — **вне U5**: DebugOverlay (F-10) — содержание не заказанного владельцем этапа U4.
