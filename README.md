...
- [ ] **Композиция моделей** — FR-029 (порты значений) → R2–R5 CR-013
  (чтение графа, батч `graph_apply`, композитные шаблоны, рецепт агентов);
  эталоны приёмки — ADR-0005/ADR-0006
